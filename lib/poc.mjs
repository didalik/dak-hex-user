...
function demoAnn (poc) { // {{{1
  ...
  setTimeout(poc.Ann.resolve, 17000, { tag: 'Ann', timeout: '17s' })
}
...
function demoBob (poc, resolve, reject, tag, r) { // {{{1
  ...
  setTimeout(poc.Bob.resolve, 16000, { tag: 'Bob', timeout: '16s' })
}

function demoCyn (poc) { // {{{1
  let { s, e, c, d } = this
  setTimeout(poc.Cyn.resolve, 1000, { tag: 'Cyn', timeout: '1s' })
}
