...
function makeClaimableBalance ( // {{{1
  claimants, maker, kp, amount, opsData = [], memo = null
) {
  let { s, e, c, d } = this
...
export { // {{{1
  addHEX_CREATOR, addHEX_Agent, addHEX_Issuer, createAccount, 
  loadKeys, makeBuyOffer, makeClaimableBalance, makeSellOffer,
